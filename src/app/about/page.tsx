  ...
  return (
    ...
    >
      ...
      <section className="w-full bg-gold py-12 flex flex-col items-center justify-center text-center shadow-lg relative">
        <Image src="/images/LOGO Mabelle-01.png" alt="Logo Mabelle Consulting" width={120} height={120} className="mx-auto mb-4 rounded-full bg-white p-2 shadow-lg" />
      ...
      <section className="w-full max-w-5xl px-4 py-12 flex flex-col items-center">
        ...
        {(() => {
          const team = aboutData?.team && aboutData.team.length > 0
            ? [
                ...aboutData.team,
                ...fallbackTeam.filter(ft => !aboutData.team?.some(t => t.name.trim().toLowerCase() === ft.name.trim().toLowerCase())),
              ]
            : fallbackTeam;
